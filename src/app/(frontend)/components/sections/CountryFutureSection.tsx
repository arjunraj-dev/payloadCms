...
export interface CountryFutureSectionProps {
  ...
  variant?: 'default' | 'updates' | 'progress'
}
          ...
          <Reveal
            ...
            className={cn(
              ...
              isProgress
                ...
                : cn(
                    'max-w-[557px]',
                    !isUpdates && 'mx-auto text-center lg:mx-0 lg:text-left',
                  ),
            )}
          >
                ...
                className={cn(
                  ...
                  isProgress
                    ...
                    : cn(
                        ...
                        isUpdates ? 'mt-4 max-w-[550px]' : 'mx-auto mt-[13px] max-w-[546px] lg:mx-0',
                      ),
                )}
              >
                {subtitle}
